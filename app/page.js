...
const french = {
  ...
  "A big thank you to EV24 for their rigour and professionalism. A team that is always attentive and available.": "Un grand merci à EV24 pour sa rigueur et son professionnalisme. Une équipe toujours à l'écoute et disponible.",
...
function App() {
  ...
  return (
    <main id="top">
      ...
      <section className="section container testimonial-section" id="about"><div className="quote-mark">“</div><blockquote>{t("A big thank you to EV24 for their rigour and professionalism. A team that is always attentive and available.")}</blockquote><div className="quote-by"><div className="avatar">FB</div><div><strong>Freddy Boukhris</strong><span>Borneeco</span></div></div></section>
