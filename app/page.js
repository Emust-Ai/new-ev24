...
function App() {
  ...
  return (
    <main id="top">
      ...
      <section className="cta-section" id="contact"><div className="container"><div className="cta-panel"><div><span className="kicker kicker-light">{t("Support the next charge")}</span><h2>{t("Give every driver a better answer.")}</h2><p>{t("See how EV24 can connect your conversations, calls and charging operations.")}</p></div><div className="cta-actions"><a className="button button-white" href="mailto:front@ask-innovation.com">{t("Book a personalised demo")} <Icon name="arrow" size={17}/></a><span>front@ask-innovation.com<br/>+33 1 85 41 28 67</span></div></div></div></section>
